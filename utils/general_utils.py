...
def get_validate_args():
    ...
    parser.add_argument("--model-name", type=str, help="Model name.")
    parser.add_argument("--out-col-name", type=str, default=None, help="Name of the column to leave out of the data.")
    parser.add_argument("--data-workers", type=int, help="Number of data workers.")
    parser.add_argument("--prefetch-factor", type=int, help="Prefetch factor.")
    parser.add_argument("--preload", type=int, help="Preload flag.")
    parser.add_argument(
        "--num-folds", type=int, help="Number of folds for cross-validation."
    )
